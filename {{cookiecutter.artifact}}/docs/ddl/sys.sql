...
CREATE TABLE `sys_setting` (
  ...
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `option_label` varchar(64) CHARACTER SET utf8mb4 NOT NULL COMMENT '选项',
  `option_value` varchar(128) CHARACTER SET utf8mb4 NOT NULL COMMENT '选项值',
  `data_type` varchar(32) CHARACTER SET utf8mb4 NOT NULL DEFAULT 'string' COMMENT 'Java数据类型',
  `description` varchar(64) CHARACTER SET utf8mb4 NOT NULL COMMENT '选项描述',
  `default_value` varchar(128) CHARACTER SET utf8mb4 NOT NULL COMMENT '默认值',
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `sys_setting` (`option_label`, `option_value`, `data_type`, `description`, `default_value`) VALUES ('captcha.digits', '4', 'java.lang.Integer', '验证码位数/长度', '4');
