...
INSERT INTO `auth_permission` (`id`, `name`, `code`, `description`, `parent_id`, `kind`, `path`, `sort`) VALUES (64, 'IP访问控制管理', 'sys:acl:*', NULL, 1, 2, NULL, 1);
INSERT INTO `auth_permission` (`id`, `name`, `code`, `description`, `parent_id`, `kind`, `path`, `sort`) VALUES (65, 'IP访问控制列表分页查询', 'sys:acl:list', NULL, 64, 2, NULL, 1);
INSERT INTO `auth_permission` (`id`, `name`, `code`, `description`, `parent_id`, `kind`, `path`, `sort`) VALUES (66, '新增IP访问控制', 'sys:acl:add', NULL, 64, 2, NULL, 1);
INSERT INTO `auth_permission` (`id`, `name`, `code`, `description`, `parent_id`, `kind`, `path`, `sort`) VALUES (67, '按ID查询IP访问控制', 'sys:acl:get', NULL, 64, 2, NULL, 1);
INSERT INTO `auth_permission` (`id`, `name`, `code`, `description`, `parent_id`, `kind`, `path`, `sort`) VALUES (68, '按ID更新IP访问控制', 'sys:acl:update', NULL, 64, 2, NULL, 1);
INSERT INTO `auth_permission` (`id`, `name`, `code`, `description`, `parent_id`, `kind`, `path`, `sort`) VALUES (69, '按ID删除IP访问控制', 'sys:acl:delete', NULL, 64, 2, NULL, 1);
...
-- ----------------------------
BEGIN;
INSERT INTO `auth_user` (`id`, `username`, `pwd`, `nickname`, `mobile`, `email`, `locked`, `admin`, `expire_time`, `pwd_change_time`, `enabled`) VALUES (1, 'admin', '$2a$10$2R/BL6V3lGNRAE2KeyYK8eZsFjKVr2RS8P8yduz3JywSX22pgv7ge', '管理员', '13111111111', 'admin@example.com', 0, 1, '2099-12-31 23:59:59', NOW(), 1);
COMMIT;
...
CREATE TABLE `auth_question` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='安全问题';
