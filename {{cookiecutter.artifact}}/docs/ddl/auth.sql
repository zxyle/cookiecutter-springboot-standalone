...
CREATE TABLE `auth_user` (
  ...
  `password` varchar(64) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '加密后的密码',
  `nickname` varchar(16) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '昵称/名字/真实姓名（只用于展示）',
  ...
  `last_ip` varchar(45) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '最后登录IP',
  `avatar` varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '头像URL',
