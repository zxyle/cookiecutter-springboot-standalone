...
INSERT INTO `auth_permission` (`id`, `name`, `code`, `description`, `parent_id`, `kind`, `path`, `sort`) VALUES (121, '意见反馈所有权限', 'sys:feedback:*', NULL, 1, 2, NULL, 1);
INSERT INTO `auth_permission` (`id`, `name`, `code`, `description`, `parent_id`, `kind`, `path`, `sort`) VALUES (122, '意见反馈列表分页查询', 'sys:feedback:list', NULL, 121, 2, NULL, 1);
INSERT INTO `auth_permission` (`id`, `name`, `code`, `description`, `parent_id`, `kind`, `path`, `sort`) VALUES (123, '新增意见反馈', 'sys:feedback:add', NULL, 121, 2, NULL, 1);
INSERT INTO `auth_permission` (`id`, `name`, `code`, `description`, `parent_id`, `kind`, `path`, `sort`) VALUES (124, '按ID查询意见反馈', 'sys:feedback:get', NULL, 121, 2, NULL, 1);
INSERT INTO `auth_permission` (`id`, `name`, `code`, `description`, `parent_id`, `kind`, `path`, `sort`) VALUES (125, '按ID更新意见反馈', 'sys:feedback:update', NULL, 121, 2, NULL, 1);
